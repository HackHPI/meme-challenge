...
-- CreateIndex
CREATE UNIQUE INDEX "Meme_imageId_key" ON "Meme"("imageId");
...
-- AddForeignKey
ALTER TABLE "Meme" ADD CONSTRAINT "Meme_imageId_fkey" FOREIGN KEY ("imageId") REFERENCES "Image"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Meme" ADD CONSTRAINT "Meme_eventId_fkey" FOREIGN KEY ("eventId") REFERENCES "Event"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
